/*! For license information please see dialog-evaluation-mode.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
    [4371],
    {
      ...
      4629: (t, e, n) => {
        ...
        r.push([
          t.id,
          ".evaluation-mode-dialog-content[data-v-7cff6777] {\n  margin: 72px 25px auto 24px;\n}\n.evaluation-mode-dialog-title[data-v-7cff6777] {\n  margin-bottom: 8px;\n  font-size: 34px;\n  font-weight: bolder;\n  line-height: 41px;\n}\n.evaluation-mode-dialog-btn-container[data-v-7cff6777] {\n  margin-top: 64px;\n}\n.evaluation-mode-dialog-btn[data-v-7cff6777] {\n  margin-right: 16px;\n}\n.evaluation-mode-dialog-btn[data-v-7cff6777]:last-of-type {\n  margin-right: 0;\n}\n.uk-lang-ru-RU .evaluation-mode-dialog-content[data-v-7cff6777] {\n  margin-top: 35px;\n}\n.uk-lang-ru-RU .evaluation-mode-dialog-btn-container[data-v-7cff6777] {\n  margin-top: 20px;\n}\n",
          "",
        ]);
        const o = r;
      },
      ...
      22802: (t, e, n) => {
        ...
        const l = (0, r.aZ)({
          setup() {
            const t = (0, r.FN)().proxy,
              e = (t, ...e) => (0, o.JE)().T(t, ...e),
              n = (0, r.Fl)(() => [
                { label: e("Upgrade Now"), action: c, cls: "uk-button-primary" },
                { label: e("Cancel"), action: u, cls: "uk-button-default" },
              ]),
              i = (0, r.Fl)(() =>
                t.$toResourceURL(
                  "static/assets/images/dialog-evaluation-mode/free-evaluation-illustration.png",
                ),
              ),
              l = (0, r.Fl)(
                () =>
                  `${t.$toResourceURL(
                    ...
                    "static/assets/images/dialog-evaluation-mode/free-evaluation-illustration@2x.png",
                  )} 2x`,
              ),
              c = () => {
                (0, o.JX)().handleCommand("activate"), window.close();
              },
              u = () => {
                window.close();
              };
            return {
              evaluationModeIllustration: i,
              evaluationModeHDIllustration: l,
              evaluationModeBtns: n,
              handleSubscribe: c,
              handleEvaluation: u,
              openDifferenceTrialFullVersionLink: () => {
                (0, A.L9)({ eventAction: "compareTrialFull" }),
                  a.ZP.fetch(s.lf.GO_DIFFERENCE_TRIAL_FULLVERSION);
              },
            };
          },
        });
        ...
        const c = (0, n(51900).Z)(
          ...
          function () {
            ...
            return e(
              ...
              {
                staticClass:
                  "evaluation-mode-dialog uk-window uk-window-dialog uk-window-default",
              },
              [
                e(
                  "div",
                ...
                t._v(" "),
                e("div", { staticClass: "uk-flex uk-height-1-1" }, [
                  e("div", { staticStyle: { width: "230px" } }, [
                    e("img", {
                      staticClass: "uk-width-1-1 uk-height-1-1",
                      attrs: {
                        draggable: "false",
                        src: t.evaluationModeIllustration,
                        srcset: t.evaluationModeHDIllustration,
                      },
                    }),
                  ]),
                  t._v(" "),
                  e(
                    "div",
                    { staticClass: "uk-flex-1 evaluation-mode-dialog-content" },
                    [
                      e("div", { staticClass: "evaluation-mode-dialog-title" }, [
                        t._v(
                          "\n        " +
                      ...
                      e("div", [
                        t._v(
                          "\n        " +
                            t._s(
                              t.$T(
                                "You are currently using Xmind Free Plan. Upgrade to Xmind Pro for full potential and commercial use.",
                              ),
                            ) +
                            "\n      ",
                        ),
                      ...
                      t._v(" "),
                      e("div", { staticClass: "uk-margin-large-top" }, [
                        e(
                          "a",
                          {
                            staticClass: "uk-button-link uk-button uk-text-left",
                            attrs: { draggable: "false", href: "#" },
                            on: { click: t.openDifferenceTrialFullVersionLink },
                          },
                          [
                            t._v(
                              "\n          " +
                      ...
                      e(
                        "div",
                        { staticClass: "evaluation-mode-dialog-btn-container" },
                        t._l(t.evaluationModeBtns, function (n, i) {
                          return e(
                            "button",
                            {
                              key: i,
                              staticClass:
                                "uk-button uk-button-default uk-text-nowrap evaluation-mode-dialog-btn",
                              class: n.cls,
                              attrs: { type: "button" },
                              on: { click: n.action },
                            },
        ...
        (0, i.Z)(c, { name: "dialog-evaluation-mode" });
      },
      30266: (t, e, n) => {
        "use strict";
        function i(t, e, n) {
      ...
      77760: (t) => {
        ...
        function O(t, e) {
          ...
          try {
            const n = Array.isArray(t),
              i = Array.isArray(e);
            if (n && i)
              return t.length === e.length && t.every((t, n) => O(t, e[n]));
            ...
            if (n || i) return !1;
            {
              const n = Object.keys(t),
                i = Object.keys(e);
              return n.length === i.length && n.every((n) => O(t[n], e[n]));
            }
          } catch (t) {
            return !1;
          }
        ...
        function Dt(t) {
          return Qt(t) ? Dt(t.__v_raw) : !(!t || !t.__ob__);
        }
        function Ot(t) {
          ...
          return (
            (v.run = () => {
              if (v.active)
                if (i) {
                  const t = v.get();
                  (o || p || (g ? t.some((t, e) => k(t, y[e])) : k(t, y))) &&
                    (d && d(),
        ...
        function Wt(t, e) {
          function i() {
            const t = i.fns;
            if (!n(t)) return Qe(t, null, arguments, e, "v-on handler");
            {
              const n = t.slice();
              for (let t = 0; t < n.length; t++)
                Qe(n[t], null, arguments, e, "v-on handler");
            }
          }
          return (i.fns = t), i;
        }
          ...
          try {
            (o = n ? t.apply(e, n) : t.call(e)),
              o &&
                ...
                f(o) &&
                !o._handled &&
                (o.catch((t) => Oe(t, i, r + " (Promise/async)")),
                (o._handled = !0));
          } catch (t) {
            Oe(t, i, r);
          }
        ...
        class ln {
          ...
          get() {
            ...
            try {
              ...
              Oe(t, e, `getter for watcher "${this.expression}"`);
            } finally {
        ...
        function Rn(t, s, a, l, c) {
          ...
          if (o(t.options.functional))
            return (function (t, i, o, s, a) {
              ...
              else r(o.attrs) && Qn(l, o.attrs), r(o.props) && Qn(l, o.props);
              const u = new Dn(o, l, a, s, t),
                f = A.render.call(null, u._c, u);
              if (f instanceof at) return On(f, o, u.parent, A);
              if (n(f)) {
                const t = qt(f) || [],
                  e = new Array(t.length);
                for (let n = 0; n < t.length; n++)
                  e[n] = On(t[n], o, u.parent, A);
                return e;
              }
            })(t, p, s, a, l);
          const g = s.on;
          ...
          if (
            ...
            (function (t) {
              ...
              if (n) {
                ...
                st(t), gt();
                const r = Qe(n, null, [t._props || xt({}), i], t, "setup");
            ...
            (t.prototype.$on = function (t, i) {
              ...
              (t.prototype.$emit = function (t) {
                ...
                if (n) {
                  ...
                  for (let t = 0, o = n.length; t < o; t++) Qe(n[t], e, i, e, r);
                }
                return e;
              });
          })(ci),
        ...
        const ji = {
          ...
          Qi = g("text,number,password,search,email,tel,url");
        ...
        function Si(t, e) {
          ...
          const o = t.context,
            ...
            A = e ? null : s,
            l = e ? void 0 : s;
          if (a(i)) return void Qe(i, o, [A], o, "template ref function");
        ...
        function Ji(t, e, n, i, r) {
          ...
          if (o)
            try {
              ...
              Oe(i, n.context, `directive ${t.name} ${e} hook`);
            }
        }
        var Wi = [ki, Gi];
        function Ki(t, e) {
        ...
        jr &&
          ...
          void 0 === window.onanimationend &&
            ...
            ((Dr = "WebkitAnimation"), (Or = "webkitAnimationEnd")));
        const Qr = V
        ...
        function Gr(t, e) {
          ...
          const j = _ && d ? d : c,
            ...
            z = (n._enterCb = L(() => {
              R && (Sr(n, T), Sr(n, x)),
                z.cancelled ? (R && Sr(n, j), k && k(n)) : Q && Q(n),
                (n._enterCb = null);
            }));
          t.data.show ||
            Zt(t, "insert", () => {
            ...
            R &&
              ...
              Lr(() => {
                Sr(n, j),
                  z.cancelled ||
                    (kr(n, T), Y || ($r(S) ? setTimeout(z, S) : Rr(n, l, z)));
              })),
            t.data.show && (e && e(), O && O(n, z)),
            R || Y || z();
        }
        function Vr(t, e) {
          const n = t.elm;
            ...
            I.cancelled ||
              ...
              m &&
                ...
                Lr(() => {
                  Sr(n, l),
                    I.cancelled ||
                      (kr(n, c), w || ($r(M) ? setTimeout(I, M) : Rr(n, a, I)));
                })),
              d && d(n, I),
              m || w || I());
          }
        ...
        function Zr(t, e, n) {
          ...
          for (let e = 0, n = t.options.length; e < n; e++)
            if (((s = t.options[e]), r))
              (o = Q(i, qr(s)) > -1), s.selected !== o && (s.selected = o);
            else if (O(qr(s), i))
      ...
      77412: (t, e, n) => {
        ...
        function v(t, n, r = {}, s, A, l) {
          ...
          for (const e in D) {
            const n = D[e];
            if (
              (i.isRef(n) && ((Q = n), !i.isRef(Q) || !Q.effect)) ||
              i.isReactive(n)
            )
              l ||
                (!b ||
                  ((O = n), i.isVue2 ? g.has(O) : a(O) && O.hasOwnProperty(p)) ||
